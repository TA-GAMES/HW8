 ...
 * The map is generated as a two-dimensional array of ints, where "0" and "2" denotes types of floor and "1" denotes wall.
        ...
        for (int x = 0; x < gridSize; x++) {
            for (int y = 0; y < gridSize; y++) {
                if (x == 0 || x == gridSize - 1 || y == 0 || y == gridSize - 1) {
                    ...
                    if (d < randomFillPercent)
                        bufferOld[x, y] = 1;
                    else
                    {
                        bufferOld[x, y] = random.NextDouble() < 0.5f ? 2 : 0;
                    }
                }
            }
        }
        ...
        for (int x = 0; x < gridSize; x++) {
            for (int y = 0; y < gridSize; y++) {
                ...
                if (surroundingWalls > 4) {
                    ...
                    bufferNew[x, y] = random.NextDouble() < 0.5f ? 2 : 0;
                }
            }
        }
